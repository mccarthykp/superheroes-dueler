...
def test_team_attack():
    ...
    assert team_two.heroes[0].current_hp == 100

    team_one.attack(team_two)

    assert team_two.heroes[0].current_hp <= 0
